...
export default function Navbar({ onNavigate, cartCount, onCartOpen }) {
    ...
    <nav className={`navbar ${scrolled ? "navbar--scrolled" : ""}`}>
      <div className="navbar__inner">
        ...
        <div className={`navbar__links ${menuOpen ? "navbar__links--open" : ""}`}>
          <button onClick={() => { onNavigate("shop"); setMenuOpen(false); }}>
            Shop
          </button>
        ...
        <button className="navbar__logo" onClick={() => onNavigate("home")}>
          <span className="navbar__logo-text">STOREX</span>
        </button>
